...
export const techGlossary: {
  areas: Record<string, GlossaryEntry>;
  progLangs: Record<string, GlossaryEntry>;
  buildTools: Record<string, GlossaryEntry>;
  frameworks: Record<string, GlossaryEntry>;
} = {
  areas: {
    compVision: {
        ...
        <>
          <>
            <TypographyMuted>
              ...
              &quot;see&quot; and interpret the visual world. Key aspects
              include:
            </TypographyMuted>
      ...
      tooltip: (
        <>
          ...
          <TypographyUnorderedList className="text-sm text-muted-foreground my-0 mt-4">
            ...
            <li>
              The &quot;deep&quot; aspect refers to networks having three to
              several hundred or thousands of layers.
            </li>
            <li>
